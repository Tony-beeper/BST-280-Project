...
Running PANDA on TCGA and GTEx expression data, followed by GSEA, revealed the top targeted pathways in pancreatic cancer. The analysis identified aberrant signaling in pathways such as **JAK/STAT signaling, TGF-β signaling, and the MAPK pathway**, which have been previously linked to various cancer types. Additionally, changes in the activity of pathways like **regulation of actin cytoskeleton, TCA cycle, and oxidative phosphorylation** can serve as indicators of transformations commonly observed in different cancers. This network analysis highlights key pathways that may contribute to pancreatic cancer development and progression.
